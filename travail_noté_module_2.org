...
[[file:./images/sheets_params_langue.png]]

Assurez-vous ensuite que la "barre de formules" soit visible :

#+ATTR_LATEX: :width 1.0\textwidth :float nil
[[file:./images/sheets_visu_barre_formule.png]]
...
#+ATTR_LATEX: :width 1.0\textwidth :float nil
[[file:./images/sheets_cols_a_et_b.png]]
...
#+ATTR_LATEX: :width 1.0\textwidth :float nil
[[file:./images/sheets_col_d_voc.png]]
...
[[file:./images/sheets_col_e_drag.png]]

#+ATTR_LATEX: :width 0.9\textwidth :float nil
[[file:./images/sheets_cols_e_et_f.png]]
...
#+ATTR_LATEX: :width 1.0\textwidth :float nil
[[file:./images/sheets_cols_g_et_h.png]]
...
#+ATTR_LATEX: :width 1.0\textwidth :float nil
[[file:./images/sheets_toutes_les_cols.png]]
